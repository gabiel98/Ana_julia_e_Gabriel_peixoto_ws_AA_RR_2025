...
<p style="display: inline-block;>
  ...
  <figure style="display: inline-block; text-align: center; width: 48%;">
    <img src="https://github.com/gabiel98/Ana_julia_e_Gabriel_peixoto_ws_AA_RR_2025/blob/main/graficos/graficos_tempo/tempo_ordenado.png" alt="Gráfico 2">
    <figcaption style="font-size: 14px; font-weight: bold;">Tempo de clock real</figcaption>
  </figure>
</p>
